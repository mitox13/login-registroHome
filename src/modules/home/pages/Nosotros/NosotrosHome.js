        ...
        <main className='container-fluid   '>
            ...
            <div className="row nosotros__container pt-3 ml-2 mr-2 d-flex align-items-start">
                <div className=" col-xl-6 col-md-5 presentacion__myfitteam p-4">
                    ...
                    Descubre las OFERTAS de los mejores partners y obtén sesiones personalizadas en nutrición & entrenamiento Físico. Encuentra el balance perfecto para ti estés donde estés.  </p>   
                    <p className='pt-3 text-white'>Conoce sobre nuestras ofertas. Solo debes registrarte</p>
